...
public final class ConfigProtos {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "le_device_list\030\005 \001(\t\022\"\n\032polling_active_d",
      "elay_usecs\030\006 \001(\005\022$\n\034polling_inactive_del" +
      "ay_msecs\030\007 \001(\005\"\337\002\n\020OptimizerOptions\022+\n#d" +
      "o_common_subexpression_elimination\030\001 \001(\010" +
      "\022\033\n\023do_constant_folding\030\002 \001(\010\022\034\n\024do_func" +
      "tion_inlining\030\004 \001(\010\0225\n\topt_level\030\003 \001(\0162\"" +
      ".tensorflow.OptimizerOptions.Level\022E\n\020gl" +
      "obal_jit_level\030\005 \001(\0162+.tensorflow.Optimi" +
      "zerOptions.GlobalJitLevel\" \n\005Level\022\006\n\002L1" +
      ...
      "ild_cost_model\030\004 \001(\003\022\036\n\026build_cost_model" +
      "_after\030\t \001(\003\022\024\n\014infer_shapes\030\005 \001(\010\022\032\n\022pl" +
      "ace_pruned_graph\030\006 \001(\010\022 \n\030enable_bfloat1" +
      "6_sendrecv\030\007 \001(\010\022\025\n\rtimeline_step\030\010 \001(\005J" +
      "\004\010\001\020\002R%skip_common_subexpression_elimina" +
      "tion\",\n\025ThreadPoolOptionProto\022\023\n\013num_thr" +
      "eads\030\001 \001(\005\"2\n\nRPCOptions\022$\n\034use_rpc_for_",
      "inprocess_master\030\001 \001(\010\"\321\004\n\013ConfigProto\022>" +
      ...
      ".tensorflow.DebugOptions\"R\n\nTraceLevel\022\014" +
      "\n\010NO_TRACE\020\000\022\022\n\016SOFTWARE_TRACE\020\001\022\022\n\016HARD" +
      "WARE_TRACE\020\002\022\016\n\nFULL_TRACE\020\003J\004\010\004\020\005\"\226\001\n\013R" +
      "unMetadata\022)\n\nstep_stats\030\001 \001(\0132\025.tensorf" +
      "low.StepStats\022,\n\ncost_graph\030\002 \001(\0132\030.tens" +
      "orflow.CostGraphDef\022.\n\020partition_graphs\030" +
      "\003 \003(\0132\024.tensorflow.GraphDefB-\n\030org.tenso" +
      "rflow.frameworkB\014ConfigProtosP\001\370\001\001b\006prot" +
      "o3"
    };
    ...
    internal_static_tensorflow_GPUOptions_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_GPUOptions_descriptor,
        new java.lang.String[] { "PerProcessGpuMemoryFraction", "AllocatorType", "DeferredDeletionBytes", "AllowGrowth", "VisibleDeviceList", "PollingActiveDelayUsecs", "PollingInactiveDelayMsecs", });
    internal_static_tensorflow_OptimizerOptions_descriptor =
